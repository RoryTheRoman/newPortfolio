        ...
        <div className="sidebar">
            <div className="card sidebar-card">
                <div className="card-body">
                    ...
                    <p className="text-left">Finding web development has been the greatest gift.  It is creativity with structure, and allows me to problem solve again.  Above else, I love the fact that it is a career in which you have to continue to learn and grow.  A developers education never stagnates</p>
                </div>
            </div>
